                ...
                <div class="card-body">
                    ...
                    @method('PUT')
                        ...
                        <div class="form-group row option-item">
                            ...
                            <div class="col-6">
                            <textarea id="intro-textarea" class="form-control ckeditor" maxlength="225" rows="5" name="intro">{{old('intro', $course->intro)}}</textarea>
                        ...
                        <div class="form-group row option-item">
                            ...
                            <div class="col-6">
                            <input class="form-control" maxlength="225" rows="5" name="video" value="{{old('video', $course->video)}}">
